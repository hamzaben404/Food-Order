                        ...
                        <td>
                            <?php 
                                ...
                                if($current_image == ""){
                                    ...
                                    ?>
                                    <img src="<?php echo SITEURL.'images/food/'.$current_image ?>" width="150px">
                                    <?php
                                }
                ...
                if(isset($_POST['submit'])){
                    ...
                    if(isset($_FILES['image']['name'])){
                        ...
                        if($image_name != "")
                        {
                            ...
                            if($upload == false)
                            {
                                $_SESSION['upload'] = "<div class=''>Failed to Upload new Image.</div>";
                    ...
                    if($res3 == true)
                    {
                        ...
                        $_SESSION['update'] = "<div class='err' >Failed to update food.</div>";
                        header('location:'.SITEURL.'admin/manage_food.php');
                    }
                }
